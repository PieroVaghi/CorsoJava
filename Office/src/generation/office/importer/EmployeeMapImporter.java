...
public class EmployeeMapImporter implements generation.common.importer.Importer<Employee>
{
	String filename;
	Factory factory;
	
	public EmployeeMapImporter(String filename, Factory factory) throws FileNotFoundException, NullPointerException
	{
	...
	public ImportResult<Employee> absorb() 
	{
		...
		try
		{
			...
			while(data.hasNextLine())
			{
				...
				try
				{
					Employee single = (Employee) factory.make(_rowToMap(row));
					if(single.valid())
